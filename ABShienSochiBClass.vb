...
#Region "メンバ変数"
    ...
    ' コンスタント定義
    Private Const THIS_CLASS_NAME As String = "ABShienSochiBClass"                   ' クラス名
    ...
    Private Const ERR_SHIENSOCHI As String = "支援措置管理番号"
...
#Region "支援措置更新　[UpdateShienSochi]"
    ...
    Public Function UpdateShienSochi(ByVal csDataRow As DataRow) As Integer
        ...
        Try
            ...
            csDataRow(ABShienSochiEntity.TANMATSUID) = m_cfControlData.m_strClientId                                   '端末ＩＤ
            csDataRow(ABShienSochiEntity.KOSHINCOUNTER) = CDec(csDataRow(ABShienSochiEntity.KOSHINCOUNTER)) + 1        '更新カウンタ
            csDataRow(ABShienSochiEntity.KOSHINUSER) = m_cfControlData.m_strUserId                                     '更新ユーザー
...
#Region "支援措置情報取得"
    ...
    Public Function GetShienSochiJoho(ByVal strJumincd As String) As DataSet
        ...
        Dim csShienSochiDS As DataSet                                        ' 支援措置データ
        Dim strSQL As StringBuilder                                         ' SQL文SELECT句
