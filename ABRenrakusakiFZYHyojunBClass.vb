...
#Region "メンバー変数"
    ...
    ' コンスタント定義
    Private Const THIS_CLASS_NAME As String = "ABRenrakusakiFZYHyojunBClass"              ' クラス名
    ...
    Private Shared ReadOnly SQL_SAKUJOFG As String = String.Format("{0} = '0'", ABRenrakusakiFZYHyojunEntity.SAKUJOFG)
    ...
    Public Overloads Function SelectByKey( _
        ...
        Try
            ...
            With csSQL
                ...
                ' 住民コード
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.JUMINCD, ABRenrakusakiFZYHyojunEntity.PARAM_JUMINCD)
                ...
                ' 業務コード
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUCD, ABRenrakusakiFZYHyojunEntity.PARAM_GYOMUCD)
                ...
                ' 業務内種別コード
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUNAISHU_CD, ABRenrakusakiFZYHyojunEntity.PARAM_GYOMUNAISHU_CD)
                ...
                ' 登録連番
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.TOROKURENBAN, ABRenrakusakiFZYHyojunEntity.PARAM_TOROKURENBAN)
            ...
            ' 抽出処理を実行
            csRenrakusakiFZYHyojunEntity = Me.Select(csSQL.ToString(), m_cfSelectParamCollection)
    ...
    Private Function CreateSelect() As String
        ...
        Try
            ...
            With csSQL
                ...
                .Append("SELECT ")
                .Append(ABRenrakusakiFZYHyojunEntity.JUMINCD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.GYOMUCD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.GYOMUNAISHU_CD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.TOROKURENBAN)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKI_STYMD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKI_EDYMD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU1)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU2)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU3)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU4)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU5)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHUBETSU6)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIYUBINNO)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIJUSHOCD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIJUSHO)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHIKUCHOSONCD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIMACHIAZACD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKTODOFUKEN)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKISHICHOSON)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIMACHIAZA)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIBANCHI)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIKATAGAKI)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.TOROKUYMD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.GYOSEIKUCD)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RENRAKUSAKIEDABAN)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.BIKO)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RESERVE1)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RESERVE2)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RESERVE3)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RESERVE4)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.RESERVE5)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.TANMATSUID)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.SAKUJOFG)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.KOSHINCOUNTER)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.SAKUSEINICHIJI)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.SAKUSEIUSER)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.KOSHINNICHIJI)
                .AppendFormat(", {0}", ABRenrakusakiFZYHyojunEntity.KOSHINUSER)
    ...
    Private Sub CreateInsertSQL(ByVal csDataRow As DataRow)
        ...
        Try
            ...
            m_strInsertSQL = String.Format("INSERT INTO {0} ({1}) VALUES ({2})", _
                                           ABRenrakusakiFZYHyojunEntity.TABLE_NAME, _
...
#Region "Update"
    ...
    Public Overloads Function Update( _
        ...
        Try
            ...
            ' 共通項目の編集を行う
            csDataRow(ABRenrakusakiFZYHyojunEntity.TANMATSUID) = m_cfControlData.m_strClientId                                                            ' 端末ＩＤ
            csDataRow(ABRenrakusakiFZYHyojunEntity.KOSHINCOUNTER) = CType(csDataRow(ABRenrakusakiFZYHyojunEntity.KOSHINCOUNTER), Decimal) + 1             ' 更新カウンタ
            csDataRow(ABRenrakusakiFZYHyojunEntity.KOSHINNICHIJI) = GetValue(csDataRow(ABRenrakusakiFZYHyojunEntity.KOSHINNICHIJI), strUpdateDatetime)    ' 更新日時
            csDataRow(ABRenrakusakiFZYHyojunEntity.KOSHINUSER) = m_cfControlData.m_strUserId                                                              ' 更新ユーザー
            ...
            For Each cfParam As UFParameterClass In m_cfUpdateParamCollection
                ...
                If (cfParam.ParameterName.StartsWith(ABRenrakusakiFZYHyojunEntity.PREFIX_KEY, StringComparison.CurrentCulture) = True) Then
...
#Region "CreateUpdateSQL"
    ...
    Private Sub CreateUpdateSQL(ByVal csDataRow As DataRow)
        ...
        Try
            ...
            With csWhere
                .Append("WHERE ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.JUMINCD, ABRenrakusakiFZYHyojunEntity.KEY_JUMINCD)
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUCD, ABRenrakusakiFZYHyojunEntity.KEY_GYOMUCD)
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUNAISHU_CD, ABRenrakusakiFZYHyojunEntity.KEY_GYOMUNAISHU_CD)
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.TOROKURENBAN, ABRenrakusakiFZYHyojunEntity.KEY_TOROKURENBAN)
                .Append("AND ")
                .AppendFormat("{0} = {1}", ABRenrakusakiFZYHyojunEntity.KOSHINCOUNTER, ABRenrakusakiFZYHyojunEntity.KEY_KOSHINCOUNTER)
            End With
...
#Region "CreateDeleteSQL"
    ...
    Private Sub CreateDeleteSQL(ByVal csDataRow As DataRow)
        ...
        Try
            ...
            csSQL = New StringBuilder(256)
            With csSQL
                .AppendFormat("DELETE FROM {0} ", ABRenrakusakiFZYHyojunEntity.TABLE_NAME)
                .Append("WHERE ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.JUMINCD, ABRenrakusakiFZYHyojunEntity.KEY_JUMINCD)
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUCD, ABRenrakusakiFZYHyojunEntity.KEY_GYOMUCD)
...
#Region "CreateLogicalDeleteRecoverSQL"
    ...
    Private Sub CreateLogicalDeleteRecoverSQL(ByVal csDataRow As DataRow)
        ...
        Try
            ...
            csSQL = New StringBuilder(256)
            With csSQL
                .AppendFormat("UPDATE {0} ", ABRenrakusakiFZYHyojunEntity.TABLE_NAME)
                .Append("SET ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.TANMATSUID, ABRenrakusakiFZYHyojunEntity.PARAM_TANMATSUID)
                .Append(", ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.SAKUJOFG, ABRenrakusakiFZYHyojunEntity.PARAM_SAKUJOFG)
                .Append(", ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.KOSHINCOUNTER, ABRenrakusakiFZYHyojunEntity.PARAM_KOSHINCOUNTER)
                .Append(", ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.KOSHINNICHIJI, ABRenrakusakiFZYHyojunEntity.PARAM_KOSHINNICHIJI)
                .Append(", ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.KOSHINUSER, ABRenrakusakiFZYHyojunEntity.PARAM_KOSHINUSER)
                .Append("WHERE ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.JUMINCD, ABRenrakusakiFZYHyojunEntity.KEY_JUMINCD)
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABRenrakusakiFZYHyojunEntity.GYOMUCD, ABRenrakusakiFZYHyojunEntity.KEY_GYOMUCD)
