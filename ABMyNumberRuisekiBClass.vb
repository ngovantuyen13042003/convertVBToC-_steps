...
#Region "メンバー変数"
    ...
    ' コンスタント定義
    Private Const THIS_CLASS_NAME As String = "ABMyNumberRuisekiBClass"     ' クラス名
...
#Region "Select"
    ...
    Public Overloads Function [Select]( _
        ...
        Dim csMyNumberRuisekiEntity As DataSet
    ...
    Public Overloads Function SelectByKey( _
        ...
        Try
            ...
            With csSQL
                ...
                ' 住民コード
                .AppendFormat("{0} = {1} ", ABMyNumberRuisekiEntity.JUMINCD, ABMyNumberRuisekiEntity.PARAM_JUMINCD)
                ...
                ' 共通番号
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABMyNumberRuisekiEntity.MYNUMBER, ABMyNumberRuisekiEntity.PARAM_MYNUMBER)
                ...
                ' 処理日時
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABMyNumberRuisekiEntity.SHORINICHIJI, ABMyNumberRuisekiEntity.PARAM_SHORINICHIJI)
                ...
                ' 前後区分
                .Append("AND ")
                .AppendFormat("{0} = {1} ", ABMyNumberRuisekiEntity.ZENGOKB, ABMyNumberRuisekiEntity.PARAM_ZENGOKB)
            ...
            ' 抽出処理を実行
            csMyNumberRuisekiEntity = Me.Select(csSQL.ToString(), m_cfSelectParamCollection)
    ...
    Private Function CreateSelect() As String
        ...
        Try
            ...
            With csSQL
                ...
                .Append("SELECT ")
                .Append(ABMyNumberRuisekiEntity.JUMINCD)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SHICHOSONCD)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.KYUSHICHOSONCD)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.MYNUMBER)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SHORINICHIJI)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SHORIKB)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.ZENGOKB)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.CKINKB)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.IDOKB)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.IDOYMD)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.IDOSHA)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.RESERVE)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.TANMATSUID)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SAKUJOFG)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.KOSHINCOUNTER)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SAKUSEINICHIJI)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.SAKUSEIUSER)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.KOSHINNICHIJI)
                .AppendFormat(", {0}", ABMyNumberRuisekiEntity.KOSHINUSER)
    ...
    Private Sub CreateInsertSQL(ByVal csDataRow As DataRow)
        ...
        Try
            ...
            m_strInsertSQL = String.Format("INSERT INTO {0} ({1}) VALUES ({2})", _
                                           ABMyNumberRuisekiEntity.TABLE_NAME, _
