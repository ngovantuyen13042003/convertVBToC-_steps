        ...
        public int KojinSeigyoKoshin(ABKariTorokuParamXClass cABKariTorokuPrm)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(m_strKTorokuMsg.Trim()))
                {
                    ...
                    {
                        m_strKTorokuMsg = (string)csKTourokuDS.Tables(ABAtenaKanriJohoEntity.TABLE_NAME).Rows(0).Item(ABAtenaKanriJohoEntity.PARAMETER);
                    }
                }
                ...
                else
                {
                    ...
                    intRirekiNo = (int)csSortDataRow[0].Item(ABKojinseigyoRirekiEntity.RIREKINO).ToString() + 1;
                }
