...
#Region "メンバ変数"
    ...
    Private m_cABAtenaKanriJohoB As ABAtenaKanriJohoBClass          ' 管理情報Ｂクラス
    Private m_strShimeiKakkoKB_param As String                      ' 氏名括弧制御区分パラメータ
    Private m_cABMojiRetsuHenshuB As ABMojiretsuHenshuBClass        ' 文字列編集Ｂクラス 
    ...
    Private Const HIDARI_KAKKO As String = "（"
    Private Const MIGI_KAKKO As String = "）"
