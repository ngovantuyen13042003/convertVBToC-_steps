...
namespace Densan.Reams.AB.AB000BB
{
    ...
    public class ABAtenaJiteupBClass
    {
        ...
        private const string WORK_FLOW_NAME = "宛名児手個別事項";         // ワークフロー名
        private const string DATA_NAME = "児手個別";                      // データ名
                                                                      // *履歴番号 000002 2005/10/13 追加終了
        #endregion
        ...
        public void WorkFlowSet(ABKobetsuJiteProperty[] cABKobetsuProperty)
        {
            ...
            var csABJiteEntity = new DataSet();                 // 個別事項児手データセット
            DataTable csABJiteTable;                      // 個別事項児手データテーブル
            DataRow csABJiteRow;                          // 個別事項児手データロウ
            string strNen;                                // 作成日時
